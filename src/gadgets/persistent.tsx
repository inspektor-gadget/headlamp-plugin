...
export function PersistentGadget(props: {
  ...
  const { gadgetID, gadgetName, gadgetCategory, GadgetResultComponent, title, startMessage } =
    props;
    ...
    return (
      <Box py={2}>
        <Grid container direction="column" justifyContent="center" alignItems="center" spacing={2}>
          <Grid item>
            <Typography variant="h6">{startMessage}</Typography>
          </Grid>
          <Grid item>
            <IconButton onClick={startGadgetHandler} size="large">
