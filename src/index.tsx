...
registerDetailsViewSection(({ resource }: DetailsViewSectionProps) => {
  ...
  if (resource) {
    return (
      ...
      <SectionBox title={<Box display="flex" alignItems="center" ml={2}>
        <Box><Typography variant="h5">Inspektor Gadget</Typography></Box>
       <Box>
      ...
      { isResourceEmbedded ?  <RunningGadgetsForResource resource={resource} open={open}/> : <EmptyContent>
